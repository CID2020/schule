...
class Vec(tuple):
  ...
  def __new__(cls, *args): #return tuple instead of b.pos schreiben muss
  ...
  def rotate2D(self, rotationspunkt, winkel_rad):
    """
    Rotiert einen Punkt im Uhrzeigersinn um einen gegebenen Winkel 
    um einen gegebenen Rotationspunkt (= Pivot)
